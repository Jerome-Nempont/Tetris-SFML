...
{
    m_fenetre=&fenetre;
//Chargement des image concernant le menu
    ...
    //definitions des boites boutons
...
//Inititialisation individuels de chaque image
void Menu::initMenuP()
{
...
//Affiche le Menu selon son état 
